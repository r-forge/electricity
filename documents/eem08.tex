...
\title{Generation Capacity Investment in Electricity Markets under Uncertainty}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Anton Burger}
\IEEEauthorblockA{Research Institute for Regulatory Economics\\
Vienna University of Economics and Business Administration\\
Email: \href{mailto:anton.burger@wu-wien.ac.at}{anton.burger@wu-wien.ac.at}}
\and
\IEEEauthorblockN{Robert Ferstl}
\IEEEauthorblockA{Department of Finance\\
University of Regensburg\\
Email: \href{mailto:robert.ferstl@wiwi.uni-regensburg.de}{robert.ferstl@wiwi.uni-regensburg.de}}
}
...
\begin{IEEEkeywords}
Electricity markets, investment decisions, stochastic oligopoly model, sample path optimization, stochastic programming.
\end{IEEEkeywords}
