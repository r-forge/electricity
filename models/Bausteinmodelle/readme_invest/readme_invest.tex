...
Total quantities and prices the firms offer in each market state and for each scenario are given in table. Of course, prices are lower in the low demand scenario but in the high demand scenario. However, in both cases, due
