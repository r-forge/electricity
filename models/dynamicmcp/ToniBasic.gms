...
alphaz   alpha zero                      / 100 /
beta     demand function slope           /0.75 /

Parameter
c variable kosten  /3 /

capc capacity costs   /    10  /
...
model monop  /profit0.q0, profit1.q1, restr0.y0, restr1.y1, invest.inv, state.u, kapa.cap1, pricecap0.psi0, pricecap1.psi1, price0, price1/

solve monop using mcp;

display q0.l, q1.l, y0.l, y1.l, inv.l,cap0, cap1.l , p0.l, p1.l