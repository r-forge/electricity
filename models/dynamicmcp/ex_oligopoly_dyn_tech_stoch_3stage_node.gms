...
profit_n3(i,j) .. -0.25*(alpha_n3 - beta*sum((l,m),q_n3(l,m)) - beta*sum(m,q_n3(i,m)) - c(j)) + lambda_n3(i,j) =g= 0;
profit_n4(i,j) .. -0.25*(alpha_n4 - beta*sum((l,m),q_n4(l,m)) - beta*sum(m,q_n4(i,m)) - c(j)) + lambda_n4(i,j) =g= 0;
profit_n5(i,j) .. -0.25*(alpha_n5 - beta*sum((l,m),q_n5(l,m)) - beta*sum(m,q_n5(i,m)) - c(j)) + lambda_n5(i,j) =g= 0;
profit_n6(i,j) .. -0.25*(alpha_n6 - beta*sum((l,m),q_n6(l,m)) - beta*sum(m,q_n6(i,m)) - c(j)) + lambda_n6(i,j) =g= 0;
...
state3_n1(i,j) .. 0.5*F(j) - phi_n3(i,j) - phi_n4(i,j) =g= 0;
state3_n2(i,j) .. 0.5*F(j) - phi_n5(i,j) - phi_n6(i,j) =g= 0;
