...
state_n7(i,j) .. K_n7(i,j) - K_n3(i,j) - In_n3(i,j) =e= 0;
state_n8(i,j) .. K_n8(i,j) - K_n3(i,j) - In_n3(i,j) =e= 0;
state_n9(i,j) .. K_n9(i,j) - K_n4(i,j) - In_n4(i,j) =e= 0;
state_n10(i,j) .. K_n10(i,j) - K_n4(i,j) - In_n4(i,j) =e= 0;
state_n11(i,j) .. K_n11(i,j) - K_n5(i,j) - In_n5(i,j) =e= 0;
state_n12(i,j) .. K_n12(i,j) - K_n5(i,j) - In_n5(i,j) =e= 0;
state_n13(i,j) .. K_n13(i,j) - K_n6(i,j) - In_n6(i,j) =e= 0;
state_n14(i,j) .. K_n14(i,j) - K_n6(i,j) - In_n6(i,j) =e= 0;
state_n15(i,j) .. K_n15(i,j) - K_n7(i,j) - In_n7(i,j) =e= 0;
state_n16(i,j) .. K_n16(i,j) - K_n7(i,j) - In_n7(i,j) =e= 0;
state_n17(i,j) .. K_n17(i,j) - K_n8(i,j) - In_n8(i,j) =e= 0;
state_n18(i,j) .. K_n18(i,j) - K_n8(i,j) - In_n8(i,j) =e= 0;
state_n19(i,j) .. K_n19(i,j) - K_n9(i,j) - In_n9(i,j) =e= 0;
state_n20(i,j) .. K_n20(i,j) - K_n9(i,j) - In_n9(i,j) =e= 0;
state_n21(i,j) .. K_n21(i,j) - K_n10(i,j) - In_n10(i,j) =e= 0;
state_n22(i,j) .. K_n22(i,j) - K_n10(i,j) - In_n10(i,j) =e= 0;
state_n23(i,j) .. K_n23(i,j) - K_n11(i,j) - In_n11(i,j) =e= 0;
state_n24(i,j) .. K_n24(i,j) - K_n11(i,j) - In_n11(i,j) =e= 0;
state_n25(i,j) .. K_n25(i,j) - K_n12(i,j) - In_n12(i,j) =e= 0;
state_n26(i,j) .. K_n26(i,j) - K_n12(i,j) - In_n12(i,j) =e= 0;
state_n27(i,j) .. K_n27(i,j) - K_n13(i,j) - In_n13(i,j) =e= 0;
state_n28(i,j) .. K_n28(i,j) - K_n13(i,j) - In_n13(i,j) =e= 0;
state_n29(i,j) .. K_n29(i,j) - K_n14(i,j) - In_n14(i,j) =e= 0;
state_n30(i,j) .. K_n30(i,j) - K_n14(i,j) - In_n14(i,j) =e= 0;
state_n31(i,j) .. K_n31(i,j) - K_n15(i,j) - In_n15(i,j) =e= 0;
state_n32(i,j) .. K_n32(i,j) - K_n15(i,j) - In_n15(i,j) =e= 0;
state_n33(i,j) .. K_n33(i,j) - K_n16(i,j) - In_n16(i,j) =e= 0;
state_n34(i,j) .. K_n34(i,j) - K_n16(i,j) - In_n16(i,j) =e= 0;
state_n35(i,j) .. K_n35(i,j) - K_n17(i,j) - In_n17(i,j) =e= 0;
state_n36(i,j) .. K_n36(i,j) - K_n17(i,j) - In_n17(i,j) =e= 0;
state_n37(i,j) .. K_n37(i,j) - K_n18(i,j) - In_n18(i,j) =e= 0;
state_n38(i,j) .. K_n38(i,j) - K_n18(i,j) - In_n18(i,j) =e= 0;
state_n39(i,j) .. K_n39(i,j) - K_n19(i,j) - In_n19(i,j) =e= 0;
state_n40(i,j) .. K_n40(i,j) - K_n19(i,j) - In_n19(i,j) =e= 0;
state_n41(i,j) .. K_n41(i,j) - K_n20(i,j) - In_n20(i,j) =e= 0;
state_n42(i,j) .. K_n42(i,j) - K_n20(i,j) - In_n20(i,j) =e= 0;
state_n43(i,j) .. K_n43(i,j) - K_n21(i,j) - In_n21(i,j) =e= 0;
state_n44(i,j) .. K_n44(i,j) - K_n21(i,j) - In_n21(i,j) =e= 0;
state_n45(i,j) .. K_n45(i,j) - K_n22(i,j) - In_n22(i,j) =e= 0;
state_n46(i,j) .. K_n46(i,j) - K_n22(i,j) - In_n22(i,j) =e= 0;
state_n47(i,j) .. K_n47(i,j) - K_n23(i,j) - In_n23(i,j) =e= 0;
state_n48(i,j) .. K_n48(i,j) - K_n23(i,j) - In_n23(i,j) =e= 0;
state_n49(i,j) .. K_n49(i,j) - K_n24(i,j) - In_n24(i,j) =e= 0;
state_n50(i,j) .. K_n50(i,j) - K_n24(i,j) - In_n24(i,j) =e= 0;
state_n51(i,j) .. K_n51(i,j) - K_n25(i,j) - In_n25(i,j) =e= 0;
state_n52(i,j) .. K_n52(i,j) - K_n25(i,j) - In_n25(i,j) =e= 0;
state_n53(i,j) .. K_n53(i,j) - K_n26(i,j) - In_n26(i,j) =e= 0;
state_n54(i,j) .. K_n54(i,j) - K_n26(i,j) - In_n26(i,j) =e= 0;
state_n55(i,j) .. K_n55(i,j) - K_n27(i,j) - In_n27(i,j) =e= 0;
state_n56(i,j) .. K_n56(i,j) - K_n27(i,j) - In_n27(i,j) =e= 0;
state_n57(i,j) .. K_n57(i,j) - K_n28(i,j) - In_n28(i,j) =e= 0;
state_n58(i,j) .. K_n58(i,j) - K_n28(i,j) - In_n28(i,j) =e= 0;
state_n59(i,j) .. K_n59(i,j) - K_n29(i,j) - In_n29(i,j) =e= 0;
state_n60(i,j) .. K_n60(i,j) - K_n29(i,j) - In_n29(i,j) =e= 0;
state_n61(i,j) .. K_n61(i,j) - K_n30(i,j) - In_n30(i,j) =e= 0;
state_n62(i,j) .. K_n62(i,j) - K_n30(i,j) - In_n30(i,j) =e= 0;
